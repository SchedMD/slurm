/*****************************************************************************\
 *  task_numa.c - Library for task pre-launch and post_termination
 *	functions for NUMA-based task support
 *****************************************************************************
 *  Copyright (C) 2005 Hewlett-Packard Development Company, L.P.
 *  Copyright (C) 2006 The Regents of the University of California and
 *  Produced at Lawrence Livermore National Laboratory (cf, DISCLAIMER).
 *  and Hewlett-Packard by Morris Jette <jette1@llnl.gov>, et. al. 
 *  UCRL-CODE-217948.
 *  
 ...
 */
const char plugin_name[]        = "task numa plugin";
const char plugin_type[]        = "task/numa";
...
{
	debug("numa task_pre_launch: %u.%u, task %d", 
...
{
	debug("numa task_post_term: %u.%u, task %d",
		job->jobid, job->stepid, job->envtp->procid);
