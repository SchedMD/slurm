...
{ 
	...
	switch(type) {
	case HEADLINE:
		printf("%-25s", "MaxPages/Node:Task - Ave");
		break;
	case UNDERSCORE:
		printf("%-25s", "------------------------");
		break;
	case JOB:
		...
		if(job->track_steps)
			...
			snprintf(outbuf, FORMAT_STRING_SIZE, "%s/%u:%u - %s", 
				 buf1,
				 sacct.max_pages_id.nodeid,
...
{ 
	...
	switch(type) {
	case HEADLINE:
		printf("%-22s", "MaxRSS/Node:Task - Ave");
		break;
	case UNDERSCORE:
		printf("%-22s", "----------------------");
		break;
...
{ 
	...
	switch(type) {
	case HEADLINE:
		printf("%-24s", "MaxVSIZE/Node:Task - Ave");
		break;
	case UNDERSCORE:
		printf("%-24s", "------------------------");
		break;
...
{ 
	...
	switch(type) {
	case HEADLINE:
		printf("%-26s", "MinCPUtime/Node:Task - Ave");
		break;
	case UNDERSCORE:
		printf("%-26s", "--------------------------");
		break;
