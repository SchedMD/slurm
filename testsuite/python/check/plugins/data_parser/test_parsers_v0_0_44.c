 ...
 *
 * Test every parser in the data_parser/v0.0.44 parsers[] table.
 *****************************************************************************/

/*
 * One libcheck test unit per parser in the data_parser/v0.0.44 parsers[]
 ...
 * with src/plugins/data_parser/v0.0.44/, not with the other versions.
 */

#define _GNU_SOURCE

#define DATA_PARSER_PLUGIN_TYPE "data_parser/v0.0.44"
/*
 * plugin_load_and_link() appends ".so" and maps only '/' to '_', never '.', so
 * the load name must already be underscored to find data_parser_v0_0_44.so.
 * Do not "fix" this to match DATA_PARSER_PLUGIN_TYPE.
 */
#define DATA_PARSER_PLUGIN_NAME "data_parser/v0_0_44"
...
#include "src/plugins/data_parser/v0.0.44/parsers.h"
