...
#define SLURM_26_11_PROTOCOL_VERSION MAKE_SLURM_VER(46)
#define SLURM_26_05_PROTOCOL_VERSION MAKE_SLURM_VER(45)
#define SLURM_25_11_PROTOCOL_VERSION MAKE_SLURM_VER(44)
#define SLURM_25_05_PROTOCOL_VERSION MAKE_SLURM_VER(43)

#define SLURM_PROTOCOL_VERSION SLURM_26_11_PROTOCOL_VERSION
...
#if 0
/*
 * Old Slurm protocol versions kept for reference only.
 * Slurm only actively keeps track of three previous versions.
 */
