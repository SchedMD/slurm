 ...
 * IN - local_proc_id
 */
static void _filter_gres_per_task(bitstr_t *usable_gres,
				  char *gpus_per_task_str, int local_proc_id)
{
	int gpus_per_task = strtol(gpus_per_task_str, NULL, 0);
				...
				int local_proc_id)
{
	...
	char *sep, *map_gpu = NULL, *mask_gpu = NULL, *gpus_per_task = NULL;
	bitstr_t *usable_gres = NULL;
