...
static const http_status_code_txt_t http_status_codes[] = {
	...
	/* rfc7168 */
	{ HTTP_STATUS_CODE_ERROR_IM_A_TEAPOT, "I'm a Teapot" },
	/* rfc9110 15.5.20 */
	{ HTTP_STATUS_CODE_ERROR_MISDIRECT_REQUESTED, "MISDIRECTED REQUEST" },
	/* rfc9110 15.5.21 */
	{ HTTP_STATUS_CODE_ERROR_UNPROCESSABLE_CONTENT,
	  "UNPROCESSABLE CONTENT" },
	/* rfc7231 6.5.15 */
	{ HTTP_STATUS_CODE_ERROR_UPGRADE_REQUIRED, "UPGRADE REQUIRED" },
