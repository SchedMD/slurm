...
static const struct {
	...
	T(ESLURM_REST_BAD_REQUEST, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_INVALID_CHAR, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_INVALID_ESCAPED, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_INVALID_COMMENT, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_UNEXPECTED_DICTIONARY_END, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_UNCLOSED_DICTIONARY, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_INVALID_DICTIONARY_KEY, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_INVALID_DICTIONARY_COLON, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_UNEXPECTED_LIST_END, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_UNCLOSED_LIST, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_MISSING_COMMA, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_UNEXPECTED_COMMA, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_UNCLOSED_QUOTED_STRING, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_PARSE_FAILED, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_PARSE_DEPTH_MIN, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_JSON_PARSE_DEPTH_MAX, HTTP_STATUS_CODE_ERROR_ENTITY_TOO_LARGE),
	T(ESLURM_UTF_INVALID_CODE, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF8_INVALID_READ, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF8_READ_ILLEGAL_TERMINATION, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF8_INVALID_BYTE_2, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF8_INVALID_BYTE_3, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF8_INVALID_BYTE_4, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF_RESERVED_CODE, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF16_SURROGATE_CODE, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF_PRIVATE_CODE, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF_NONCHARACTER_CODE, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF_NULL_CODE, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	/* Only UTF-8 is accepted; a UTF-16/32 BOM is an unusable encoding */
	T(ESLURM_UTF16BE_SCHEMA, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF16LE_SCHEMA, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF32BE_SCHEMA, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	T(ESLURM_UTF32LE_SCHEMA, HTTP_STATUS_CODE_ERROR_BAD_REQUEST),
	// clang-format on
};
