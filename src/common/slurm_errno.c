...
slurm_errtab_t slurm_errtab[] = {
	...
	{ ERRTAB_ENTRY(ESLURM_JSON_UNEXPECTED_DICTIONARY),
	  "Invalid or unexpected JSON object"},
	...
	{ ERRTAB_ENTRY(ESLURM_JSON_INCOMPLETE_DICTIONARY_KEY),
	  "JSON object key without value present"},
	{ ERRTAB_ENTRY(ESLURM_JSON_INVALID_DICTIONARY_COLON),
	  "Unexpected JSON object colon"},
	{ ERRTAB_ENTRY(ESLURM_JSON_UNEXPECTED_LIST),
	  "Invalid or unexpected JSON array"},
	...
	{ ERRTAB_ENTRY(ESLURM_JSON_UNEXPECTED_QUOTES),
	  "Invalid or unexpected JSON quotes character"},
	{ ERRTAB_ENTRY(ESLURM_JSON_UNEXPECTED_QUOTED_STRING),
	  "Invalid or unexpected JSON quoted string"},
	{ ERRTAB_ENTRY(ESLURM_JSON_UNCLOSED_QUOTED_STRING),
	  "JSON quoted string not closed"},
	{ ERRTAB_ENTRY(ESLURM_JSON_UNEXPECTED_UNQUOTED_STRING),
	  "Invalid or unexpected JSON unquoted string"},
	...
	{ ERRTAB_ENTRY(ESLURM_JSON_PARSE_DEPTH_MIN),
	  "Rejecting JSON with unbalanced stackewd objects or arrays"},
