...
static const entry_t msg_types[] = {
	...
	ENTRY(REQUEST_NODE_HEALTH_CHECK),
	ENTRY(PERSIST_RC),
	...
	ENTRY(REQUEST_TOPO_CONFIG),
	ENTRY(RESPONSE_TOPO_CONFIG),
	...
	ENTRY(REQUEST_HOSTLIST_EXPANSION),
	ENTRY(RESPONSE_HOSTLIST_EXPANSION),
	ENTRY(REQUEST_ASSOC_MGR_INFO),
	ENTRY(RESPONSE_ASSOC_MGR_INFO),
	ENTRY(REQUEST_UPDATE_HRES),
	...
	ENTRY(REQUEST_RUN_POWER_ACTION),
	...
	ENTRY(REQUEST_RESOURCE_LAYOUT),
	ENTRY(RESPONSE_RESOURCE_LAYOUT),
	...
	ENTRY(REQUEST_STEPMGR_RESIZE_KILL_STEPS),
	...
	ENTRY(REQUEST_STEPS_DRAINED_SUBSCRIBE),
	ENTRY(REQUEST_HET_STEP_ID),
	ENTRY(RESPONSE_HET_STEP_ID),
