...
static const parser_t PARSER_ARRAY(JOB_DESC_MSG)[] = {
	...
	add_parse(UINT32_NO_VAL, req_switch, "required_switches", "Minimum number of switches"),
	...
	add_parse(UINT32, wait4switch, "wait_for_switch", "Maximum time to wait for minimum switches in seconds"),
	add_parse(STRING, wckey, "wckey", "Workload characterization key"),
