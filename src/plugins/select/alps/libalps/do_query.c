...
extern enum basil_version get_basil_version(void)
{
	...
	if (_get_alps_engine(engine_version, sizeof(engine_version)) == NULL)
	...
	else if (xstrncmp(engine_version, "latest", 6) == 0) {
		bv = BV_5_2_3;
	} else if (xstrncmp(engine_version, "5.2", 3) == 0) {
		int macro = atoi(engine_version+4);
		if (macro >= 3) /* means 5.2.44+ */
			bv = BV_5_2_3;
		else
			bv = BV_5_2;
	} else if (xstrncmp(engine_version, "5.1", 3) == 0)
		bv = BV_5_1;
	else if (xstrncmp(engine_version, "5.0", 3) == 0)
		bv = BV_5_0;
	else if (xstrncmp(engine_version, "4.2.0", 5) == 0)
		bv = BV_4_1;
	else if (xstrncmp(engine_version, "4.1.0", 5) == 0)
		bv = BV_4_1;
	else if (xstrncmp(engine_version, "4.0", 3) == 0)
		bv = BV_4_0;
	else if (xstrncmp(engine_version, "3.1.0", 5) == 0)
		bv = BV_3_1;
	else if (xstrncmp(engine_version, "1.3.0", 5) == 0)
		/*
		 ...
		 */
		bv = BV_3_1;
	else if (xstrncmp(engine_version, "1.2.0", 5) == 0)
		bv = BV_1_2;
	else if (xstrncmp(engine_version, "1.1", 3) == 0)
		bv = BV_1_1;
	else
