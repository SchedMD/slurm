/*****************************************************************************\
 *  site_factor_example.c - example site_factor plugin
*****************************************************************************
 ...
 */
const char plugin_name[] = "example site_factor plugin";
const char plugin_type[] = "site_factor/example";
...
extern void site_factor_p_set(job_record_t *job_ptr)
{
	...
	/* job_ptr->site_factor = (lrand48() % 10000) + NICE_OFFSET; */
