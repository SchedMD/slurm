...
typedef enum {
	...
	DATA_PARSER_UPDATE_PARTITION_MSG_LIST, /* list_t* of partition_info_t* */
	...
	DATA_PARSER_SLURMDBD_CONF, /* slurmdbd_conf_t */
	DATA_PARSER_SLURMDBD_CONF_PTR, /* slurmdbd_conf_t* */
