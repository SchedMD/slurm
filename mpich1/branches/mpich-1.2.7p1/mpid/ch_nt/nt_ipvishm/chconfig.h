...
// When MPID_HAS_HETERO is defined then you need to add chhetero.c to the project
//#define MPID_HAS_HETERO
#undef MPID_HAS_HETERO

#undef MPID_PKT_MAX_DATA_SIZE
#define MPID_PKT_MAX_DATA_SIZE 3000
...
//int nt_ipvishm_proc_info ANSI_ARGS(( int, char **, char ** ));
#define MPID_getpid(i,n,e) nt_ipvishm_proc_info((i),(n),(e))
