# Microsoft Developer Studio Project File - Name="MPIConfig" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=MPIConfig - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "MPIConfig.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "MPIConfig.mak" CFG="MPIConfig - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "MPIConfig - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "MPIConfig - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "MPIConfig - Win32 Release"
...
# Name "MPIConfig - Win32 Release"
# Name "MPIConfig - Win32 Debug"
...
SOURCE=.\RegistrySettingsDialog.h
# End Source File
# Begin Source File
