...
static void PrintHelp()
{
    ...
    printf("\nDATABASE OPERATIONS:\n");
    printf("dbcreate\n");
    printf("dbcreate name\n");
    printf("dbdestroy name\n");
    printf("dbput name:key:value or name=x key=x value=x\n");
    printf("dbget name:key or name=x key=x\n");
    printf("dbdelete name:key or name=x key=x\n");
    printf("dbfirst name\n");
    printf("dbnext name\n");
    printf("dbfirstdb\n");
    printf("dbnextdb\n");
    printf("\nFILE OPERATIONS:\n");
    printf("fileinit account=x password=x\n");
    printf("putfile local=filename remote=filename replace=yes/no createdir=yes/no\n");
    printf("getfile local=filename remote=filename replace=yes/no createdir=yes/no\n");
    printf("getdir path=fullpath\n");
    printf("createtmpfile host=x\n");
    printf("deletetmpfile host=x file=x\n");
    printf("\nPROCESS OPERATIONS:\n");
    printf("launch h=host c=cmd e=env m=map d=dir a=account p=password 0=stdin 1=stdout 2=stderr k=rank\n");
    printf("getpid launchid\n");
    printf("geterror launchid\n");
    printf("getexitcode launchid\n");
    printf("getexitcodewait launchid\n");
    printf("freeprocess launchid\n");
    printf("kill launchid\n");
    printf("kill host=x pid=x\n");
    printf("killall\n");
    printf("ps\n");
    ...
    printf("delete key\n");
    printf("version\n");
    printf("mpich version\n");
    printf("stat ps, launch, config, context, tmp, barrier, forwarders, or cached\n");
    printf("setdbgoutput filename\n");
    printf("canceldbgoutput\n");
    printf("setmpduser a=account p=password\n");
    printf("clrmpduser\n");
    printf("enablempduser\n");
    printf("disablempduser\n");
    printf("\nFor a complete description of each command, see the manual - mpichntman.pdf\n\n");
}
...
void DoConsole(char *host, int port, bool bAskPwd, char *altphrase)
{
	...
	else if ((stricmp(str, "help") == 0) || (strcmp(str, "?") == 0))
	{
	    PrintHelp();
	}
	else
