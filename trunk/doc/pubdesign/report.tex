...
At present an external scheduler may submit, signal, hold, 
...
all nodes allocated to the job, or several job steps may each use a portion
of the allocation.
...
status with \slurmctld\.  The only job information it has at any given time pertains to
...
/etc/slurm.conf}.  It also can read additional state information
