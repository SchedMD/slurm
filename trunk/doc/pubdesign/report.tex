...
system suitable for use on large Linux clusters.  After surveying resource
managers available for Linux (see Appendix~\ref{survey}) and finding none
that were simple, highly scalable, and portable to different cluster 
...
As described in the preceeding section, SLURM consists of a central
...
This structure can be further broken down into subsystems:
