/*****************************************************************************\
 *  clusteracct_storage_pgsql.c - postgresql slurm node accounting plugin.
 *****************************************************************************
 ...
 * matures.
 */
const char plugin_name[] = "Cluster accounting storage POSTGRESQL plugin";
const char plugin_type[] = "clusteracct_storage/pgsql";
