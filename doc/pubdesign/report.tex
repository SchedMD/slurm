...
\marginpar{We may want to establish a signalling mechanism for jobs 
to be notified prior to system shutdown or time limit. 
In DPCS the job registers the process ID, signal, and 
lead time. Strongly recommended by David Jackson. Incidentally, 
LSF sends SIGUSR2 to the process it starts for the job, 
likely a shell performing multiple actions! --MJ}
