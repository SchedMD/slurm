...
The design also includes a scalable, general-purpose communication 
infrastructure. 
...
%will occur between the controller and \slurmd\'s.  In the case of
%interactive jobs, stdout/stderr may additionally be ``carbon copied''
%to the \srun\ command during job execution.
%
\end{itemize}
...
\marginpar{We can get this job registration and signaling 
code from DPCS. --MJ}
...
\scancel\ will prematurely terminate a queued or running job or job step.
