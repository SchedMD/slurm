/*****************************************************************************\
 *  bit_array.h - Functions to manupulate arrays of bitstrings. This permits
 ...
 * OUT strings - a NULL termininated array of pointers to bitstrings originally
 *	passed as input to bitstrings2struct()
 * RET: SLURM_SUCCESS or error code
 *
