...
c                                 function to integrate
      ...
      call PMPI_INIT( ierr )
      call PMPI_COMM_RANK( MPI_COMM_WORLD, myid, ierr )
      call PMPI_COMM_SIZE( MPI_COMM_WORLD, numprocs, ierr )
 ...
 99      format(i10)
      ...
      call PMPI_BCAST(n,1,MPI_INTEGER,0,MPI_COMM_WORLD,ierr)
...
c                                 collect all the partial sums
      call PMPI_REDUCE(mypi,pi,1,MPI_DOUBLE_PRECISION,MPI_SUM,0,
     $     MPI_COMM_WORLD,ierr)
